...
CREATE TABLE Athlete (
    ...
    CONSTRAINT athlete_hs_fk
        ...
        ON DELETE SET NULL,
    CONSTRAINT athlete_jersey_ck
        CHECK (jerseyNumber >= 0 AND jerseyNumber <= 99),
    CONSTRAINT athlete_school_jersey_uq
        UNIQUE (highSchool, jerseyNumber)
);
...
-- id is internal; jerseyNumber is the user-facing roster number
INSERT INTO Athlete (id, name, email, highSchool, jerseyNumber) VALUES
(101, 'Ethan Wong', 'ethan.wong@vancollege.ca', 'Vancouver College', 4),
(102, 'Aiden Lee', 'aiden.lee@vancollege.ca', 'Vancouver College', 7),
(103, 'Marcus Chen', 'marcus.chen@vancollege.ca', 'Vancouver College', 11),
(104, 'Owen Park', 'owen.park@vancollege.ca', 'Vancouver College', 12),
(105, 'Caleb Singh', 'caleb.singh@vancollege.ca', 'Vancouver College', 15),
(106, 'Lucas Hall', 'lucas.hall@vancollege.ca', 'Vancouver College', 21),
(107, 'Noah Lim', 'noah.lim@vancollege.ca', 'Vancouver College', 23),
(108, 'Alexander Scott', 'alexander.scott@vancollege.ca', 'Vancouver College', 30),
(109, 'Joshua Kim', 'joshua.kim@vancollege.ca', 'Vancouver College', 32),
(110, 'Samuel Nelson', 'samuel.nelson@vancollege.ca', 'Vancouver College', 35),

(111, 'Liam Chen', 'liam.chen@stpatricks.ca', 'St. Patrick Regional Secondary', 0),
(112, 'Jacob Martin', 'jacob.martin@stpatricks.ca', 'St. Patrick Regional Secondary', 3),
(113, 'Ryan OConnor', 'ryan.oconnor@stpatricks.ca', 'St. Patrick Regional Secondary', 5),
(114, 'Thomas Nguyen', 'thomas.nguyen@stpatricks.ca', 'St. Patrick Regional Secondary', 8),
(115, 'Gabriel Santos', 'gabriel.santos@stpatricks.ca', 'St. Patrick Regional Secondary', 10),
(116, 'Michael Green', 'michael.green@stpatricks.ca', 'St. Patrick Regional Secondary', 14),
(117, 'Nathan Brooks', 'nathan.brooks@stpatricks.ca', 'St. Patrick Regional Secondary', 20),
(118, 'Isaiah Turner', 'isaiah.turner@stpatricks.ca', 'St. Patrick Regional Secondary', 22),
(119, 'Daniel Adams', 'daniel.adams@stpatricks.ca', 'St. Patrick Regional Secondary', 24),
(120, 'Matthew Baker', 'matthew.baker@stpatricks.ca', 'St. Patrick Regional Secondary', 33),

(121, 'Noah Smith', 'noah.smith@doverbay.ca', 'Dover Bay Secondary', 1),
(122, 'Logan White', 'logan.white@doverbay.ca', 'Dover Bay Secondary', 2),
(123, 'Carter Wilson', 'carter.wilson@doverbay.ca', 'Dover Bay Secondary', 6),
(124, 'Evan Miller', 'evan.miller@doverbay.ca', 'Dover Bay Secondary', 9),
(125, 'Tyler Young', 'tyler.young@doverbay.ca', 'Dover Bay Secondary', 13),
(126, 'Ben Foster', 'ben.foster@doverbay.ca', 'Dover Bay Secondary', 17),
(127, 'Aaron Phillips', 'aaron.phillips@doverbay.ca', 'Dover Bay Secondary', 25),
(128, 'Connor Davis', 'connor.davis@doverbay.ca', 'Dover Bay Secondary', 31),
(129, 'Julian Reyes', 'julian.reyes@doverbay.ca', 'Dover Bay Secondary', 34),
(130, 'Adam Cooper', 'adam.cooper@doverbay.ca', 'Dover Bay Secondary', 44),

(131, 'Mason Brown', 'mason.brown@oakbay.ca', 'Oak Bay High School', 2),
(132, 'Benjamin Young', 'benjamin.young@oakbay.ca', 'Oak Bay High School', 4),
(133, 'Jackson Lee', 'jackson.lee@oakbay.ca', 'Oak Bay High School', 10),
(134, 'Cole Anderson', 'cole.anderson@oakbay.ca', 'Oak Bay High School', 12),
(135, 'Riley Evans', 'riley.evans@oakbay.ca', 'Oak Bay High School', 16),
(136, 'Hunter Scott', 'hunter.scott@oakbay.ca', 'Oak Bay High School', 21),
(137, 'Nolan Wright', 'nolan.wright@oakbay.ca', 'Oak Bay High School', 27),
(138, 'Eli Thompson', 'eli.thompson@oakbay.ca', 'Oak Bay High School', 30),
(139, 'Isaac Ward', 'isaac.ward@oakbay.ca', 'Oak Bay High School', 41),
(140, 'Dylan Price', 'dylan.price@oakbay.ca', 'Oak Bay High School', 55),

(141, 'Aarav Gill', 'aarav.gill@lamatheson.ca', 'L.A. Matheson Secondary', 0),
(142, 'Elijah King', 'elijah.king@lamatheson.ca', 'L.A. Matheson Secondary', 1),
(143, 'Rohan Sharma', 'rohan.sharma@lamatheson.ca', 'L.A. Matheson Secondary', 5),
(144, 'Jayden Ali', 'jayden.ali@lamatheson.ca', 'L.A. Matheson Secondary', 7),
(145, 'Dev Patel', 'dev.patel@lamatheson.ca', 'L.A. Matheson Secondary', 11),
(146, 'Omar Khan', 'omar.khan@lamatheson.ca', 'L.A. Matheson Secondary', 15),
(147, 'Harpreet Sidhu', 'harpreet.sidhu@lamatheson.ca', 'L.A. Matheson Secondary', 23),
(148, 'Miguel Torres', 'miguel.torres@lamatheson.ca', 'L.A. Matheson Secondary', 24),
(149, 'Andre Johnson', 'andre.johnson@lamatheson.ca', 'L.A. Matheson Secondary', 32),
(150, 'Sahil Dhillon', 'sahil.dhillon@lamatheson.ca', 'L.A. Matheson Secondary', 34),

(151, 'Kevin Zhao', 'kevin.zhao@burnabysouth.ca', 'Burnaby South Secondary', 3),
(152, 'Jason Wu', 'jason.wu@burnabysouth.ca', 'Burnaby South Secondary', 6),
(153, 'Derek Lin', 'derek.lin@burnabysouth.ca', 'Burnaby South Secondary', 8),
(154, 'Brandon Ho', 'brandon.ho@burnabysouth.ca', 'Burnaby South Secondary', 13),
(155, 'Miles Chen', 'miles.chen@burnabysouth.ca', 'Burnaby South Secondary', 14),
(156, 'Victor Lam', 'victor.lam@burnabysouth.ca', 'Burnaby South Secondary', 20),
(157, 'Justin Ma', 'justin.ma@burnabysouth.ca', 'Burnaby South Secondary', 22),
(158, 'Leo Zhang', 'leo.zhang@burnabysouth.ca', 'Burnaby South Secondary', 25),
(159, 'Eric Sun', 'eric.sun@burnabysouth.ca', 'Burnaby South Secondary', 33),
(160, 'Henry Wong', 'henry.wong@burnabysouth.ca', 'Burnaby South Secondary', 45),

(161, 'Oliver Brooks', 'oliver.brooks@kelowna.ca', 'Kelowna Secondary', 2),
(162, 'Caleb Johnson', 'caleb.johnson@kelowna.ca', 'Kelowna Secondary', 7),
(163, 'Wyatt Moore', 'wyatt.moore@kelowna.ca', 'Kelowna Secondary', 9),
(164, 'Spencer Clark', 'spencer.clark@kelowna.ca', 'Kelowna Secondary', 12),
(165, 'Blake Harris', 'blake.harris@kelowna.ca', 'Kelowna Secondary', 18),
(166, 'Graham Bell', 'graham.bell@kelowna.ca', 'Kelowna Secondary', 21),
(167, 'Jordan Hayes', 'jordan.hayes@kelowna.ca', 'Kelowna Secondary', 24),
(168, 'Simon Reeves', 'simon.reeves@kelowna.ca', 'Kelowna Secondary', 30),
(169, 'Luke Bennett', 'luke.bennett@kelowna.ca', 'Kelowna Secondary', 35),
(170, 'Max Robinson', 'max.robinson@kelowna.ca', 'Kelowna Secondary', 50),

(171, 'Dylan Carter', 'dylan.carter@kitsilano.ca', 'Kitsilano Secondary', 1),
(172, 'Finn Murphy', 'finn.murphy@kitsilano.ca', 'Kitsilano Secondary', 4),
(173, 'Theo Campbell', 'theo.campbell@kitsilano.ca', 'Kitsilano Secondary', 6),
(174, 'Owen Roberts', 'owen.roberts@kitsilano.ca', 'Kitsilano Secondary', 10),
(175, 'Miles Walker', 'miles.walker@kitsilano.ca', 'Kitsilano Secondary', 15),
(176, 'Adrian Lewis', 'adrian.lewis@kitsilano.ca', 'Kitsilano Secondary', 23),
(177, 'Felix King', 'felix.king@kitsilano.ca', 'Kitsilano Secondary', 32),
(178, 'Jonah Hughes', 'jonah.hughes@kitsilano.ca', 'Kitsilano Secondary', 34),
(179, 'Cole Morgan', 'cole.morgan@kitsilano.ca', 'Kitsilano Secondary', 42),
(180, 'Parker Hill', 'parker.hill@kitsilano.ca', 'Kitsilano Secondary', 51);
