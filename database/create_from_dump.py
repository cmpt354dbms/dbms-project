...
(101, 202, 20, 8, 15, 3, 1, 2, 2, 1, 5, 4, 1),
(101, 203, 14, 6, 13, 1, 2, 2, 1, 0, 6, 3, 2),
(101, 204, 22, 9, 17, 2, 2, 3, 3, 0, 4, 7, 3),
(101, 205, 16, 7, 12, 2, 0, 1, 2, 0, 3, 5, 1),
...
try:
    ...
    con.commit()
    print(f"Success! Database has been created with all tables and data.")
